...
-- 192 lessons in ONE statement (12 courses x 4 modules x 4 lessons).
...
values
  ('ai-video-content-creation', 'Module 1: Foundations of AI Video', 0, 'What Is AI Video Creation & Why It Matters', 0, 'video', '14 min', '[{"title":"Runway — AI video generation suite","url":"https://runwayml.com/","type":"tool"},{"title":"Runway Academy — official tool guides","url":"https://help.runwayml.com/hc/en-us","type":"docs"},{"title":"Pika — text-to-video tool","url":"https://pika.art/","type":"tool"}]'::jsonb, 'https://www.youtube.com/watch?v=FqYRkl12ON8', '## 🎯 What you will learn
...
- [ ] I have a free account on at least one AI video tool'),
  ('ai-video-content-creation', 'Module 1: Foundations of AI Video', 0, 'How AI Video Generators Think: Prompts → Clips', 1, 'video', '16 min', '[{"title":"OpenAI documentation & prompting guide","url":"https://platform.openai.com/docs","type":"docs"},{"title":"Runway Academy — official tool guides","url":"https://help.runwayml.com/hc/en-us","type":"docs"}]'::jsonb, 'https://www.youtube.com/watch?v=T_-2M_1pgoE', '## 🎯 What you will learn
...
- [ ] I generated my first AI clips'),
  ('ai-video-content-creation', 'Module 1: Foundations of AI Video', 0, 'Choosing Your AI Tool Stack (Runway, Pika & Friends)', 2, 'video', '15 min', '[{"title":"Runway — AI video generation suite","url":"https://runwayml.com/","type":"tool"},{"title":"Pika — text-to-video tool","url":"https://pika.art/","type":"tool"},{"title":"Canva Magic Studio — AI design + video","url":"https://www.canva.com/magic-studio/","type":"tool"}]'::jsonb, 'https://www.youtube.com/watch?v=FqYRkl12ON8', '## 🎯 What you will learn
...
- [ ] I wrote down my personal tool stack'),
  ('ai-video-content-creation', 'Module 1: Foundations of AI Video', 0, 'Setting Up Your AI Video Studio (Folder System & Workflow)', 3, 'video', '12 min', '[{"title":"CapCut editor (free) — assemble your AI clips","url":"https://www.capcut.com/","type":"tool"},{"title":"Runway Academy — official tool guides","url":"https://help.runwayml.com/hc/en-us","type":"docs"}]'::jsonb, 'https://www.youtube.com/watch?v=5DUHRr8x88U', '## 🎯 What you will learn
...
- [ ] I can recite the 5-stage workflow'),
  ('ai-video-content-creation', 'Module 2: Scripting & Storytelling with AI', 1, 'From Idea to Hook: Script Writing with ChatGPT', 0, 'video', '17 min', '[{"title":"OpenAI documentation & prompting guide","url":"https://platform.openai.com/docs","type":"docs"},{"title":"HubSpot — how to write video scripts","url":"https://blog.hubspot.com/marketing/video-script","type":"article"}]'::jsonb, 'https://www.youtube.com/watch?v=IMHBwskJqRo', '## 🎯 What you will learn
...
- [ ] My script reads aloud in under 35 seconds'),
  ('ai-video-content-creation', 'Module 2: Scripting & Storytelling with AI', 1, 'Writing Video Prompts That Actually Work (Shot Language)', 1, 'video', '16 min', '[{"title":"Runway Academy — official tool guides","url":"https://help.runwayml.com/hc/en-us","type":"docs"},{"title":"StudioBinder — shot types cheat sheet","url":"https://www.studiobinder.com/blog/ultimate-guide-to-camera-shots/","type":"article"}]'::jsonb, 'https://www.youtube.com/watch?v=IMHBwskJqRo', '## 🎯 What you will learn
...
- [ ] I generated 2 shots from my prompts'),
  ('ai-video-content-creation', 'Module 2: Scripting & Storytelling with AI', 1, 'Storyboarding with AI Image Frames', 2, 'video', '14 min', '[{"title":"Canva Magic Studio — AI design + video","url":"https://www.canva.com/magic-studio/","type":"tool"},{"title":"Canva Design School — storyboarding","url":"https://www.canva.com/learn/","type":"course"}]'::jsonb, 'https://www.youtube.com/watch?v=5DUHRr8x88U', '## 🎯 What you will learn
...
- [ ] I reuse identical style keywords'),
  ('ai-video-content-creation', 'Module 2: Scripting & Storytelling with AI', 1, 'Voice & Narration: Scripts That Sound Human', 3, 'video', '15 min', '[{"title":"ElevenLabs — AI voice generation","url":"https://elevenlabs.io/","type":"tool"},{"title":"ElevenLabs guides — voice design basics","url":"https://elevenlabs.io/blog","type":"article"}]'::jsonb, 'https://www.youtube.com/watch?v=T_-2M_1pgoE', '## 🎯 What you will learn
...
- [ ] I fixed pacing/pronunciation issues'),
  ('ai-video-content-creation', 'Module 3: Production — Generate, Voice, Edit', 2, 'Generating Clips: Text-to-Video & Image-to-Video', 0, 'video', '18 min', '[{"title":"Runway Academy — official tool guides","url":"https://help.runwayml.com/hc/en-us","type":"docs"},{"title":"Runway — AI video generation suite","url":"https://runwayml.com/","type":"tool"}]'::jsonb, 'https://www.youtube.com/watch?v=-og75MUlnFk', '## 🎯 What you will learn
...
- [ ] My prompts.txt grew'),
  ('ai-video-content-creation', 'Module 3: Production — Generate, Voice, Edit', 2, 'AI Voiceover Production & Lip-Sync Basics', 1, 'video', '15 min', '[{"title":"ElevenLabs — AI voice generation","url":"https://elevenlabs.io/","type":"tool"},{"title":"CapCut editor (free) — assemble your AI clips","url":"https://www.capcut.com/","type":"tool"}]'::jsonb, 'https://www.youtube.com/watch?v=5DUHRr8x88U', '## 🎯 What you will learn
...
- [ ] I know when avatars help vs hurt'),
  ('ai-video-content-creation', 'Module 3: Production — Generate, Voice, Edit', 2, 'Assembling in CapCut: Cuts, Captions & Music', 2, 'video', '19 min', '[{"title":"CapCut editor (free) — assemble your AI clips","url":"https://www.capcut.com/","type":"tool"},{"title":"CapCut — official learning hub","url":"https://www.capcut.com/","type":"docs"}]'::jsonb, 'https://www.youtube.com/watch?v=qfHX2cNA4MY', '## 🎯 What you will learn
...
- [ ] Music at 10–15% under the voice'),
  ('ai-video-content-creation', 'Module 3: Production — Generate, Voice, Edit', 2, 'Fixing AI Mistakes: Artifacts, Upscaling & Consistency', 3, 'video', '14 min', '[{"title":"Runway Academy — official tool guides","url":"https://help.runwayml.com/hc/en-us","type":"docs"},{"title":"Canva Magic Studio — AI design + video","url":"https://www.canva.com/magic-studio/","type":"tool"}]'::jsonb, 'https://www.youtube.com/watch?v=-og75MUlnFk', '## 🎯 What you will learn
...
- [ ] No visibly warped frames remain'),
  ('ai-video-content-creation', 'Module 4: Publishing, Ads & Monetization', 3, 'Platform Formats: TikTok, Reels, YouTube & WhatsApp', 0, 'video', '15 min', '[{"title":"CapCut editor (free) — assemble your AI clips","url":"https://www.capcut.com/","type":"tool"},{"title":"Social Media Examiner — platform size guide","url":"https://www.socialmediaexaminer.com/","type":"article"}]'::jsonb, 'https://www.youtube.com/watch?v=5DUHRr8x88U', '## 🎯 What you will learn
...
- [ ] I posted something real'),
  ('ai-video-content-creation', 'Module 4: Publishing, Ads & Monetization', 3, 'Making Ads & Promo Videos with AI', 1, 'video', '17 min', '[{"title":"Runway — AI video generation suite","url":"https://runwayml.com/","type":"tool"},{"title":"Meta — ad creative best practices","url":"https://www.facebook.com/business/ads-guide","type":"docs"}]'::jsonb, 'https://www.youtube.com/watch?v=-og75MUlnFk', '## 🎯 What you will learn
...
- [ ] CTA is one clear action'),
  ('ai-video-content-creation', 'Module 4: Publishing, Ads & Monetization', 3, 'Faceless Channels & Content Systems', 2, 'video', '16 min', '[{"title":"OpenAI documentation & prompting guide","url":"https://platform.openai.com/docs","type":"docs"},{"title":"ElevenLabs — AI voice generation","url":"https://elevenlabs.io/","type":"tool"}]'::jsonb, 'https://www.youtube.com/watch?v=IMHBwskJqRo', '## 🎯 What you will learn
...
- [ ] My style rule is written down'),
  ('ai-video-content-creation', 'Module 4: Publishing, Ads & Monetization', 3, 'Monetization: Clients, Rates & Getting Paid', 3, 'project', '18 min', '[{"title":"Fiverr — sell video services","url":"https://www.fiverr.com/","type":"tool"},{"title":"Upwork — freelance marketplace","url":"https://www.upwork.com/","type":"tool"},{"title":"ElevenLabs — AI voice generation","url":"https://elevenlabs.io/","type":"tool"}]'::jsonb, 'https://www.youtube.com/watch?v=T_-2M_1pgoE', '## 🎯 What you will learn
...
- [ ] Testimonial requested'),
  ('digital-marketing', 'Module 1: Marketing Foundations & Funnels', 0, 'Digital Marketing Landscape: Channels & Careers', 0, 'video', '15 min', '[{"title":"HubSpot Academy — free marketing certifications","url":"https://academy.hubspot.com/","type":"course"}]'::jsonb, 'https://www.youtube.com/watch?v=G6DmDqYLWL8', '## 🎯 What you will learn
...
- [ ] I chose my first specialty'),
  ('digital-marketing', 'Module 1: Marketing Foundations & Funnels', 0, 'Customer Personas & the Marketing Funnel', 1, 'video', '16 min', '[{"title":"HubSpot Academy — free marketing certifications","url":"https://academy.hubspot.com/","type":"course"}]'::jsonb, 'https://www.youtube.com/watch?v=G6DmDqYLWL8', '## 🎯 What you will learn
...
- [ ] I can spot stage-mismatched marketing'),
  ('digital-marketing', 'Module 1: Marketing Foundations & Funnels', 0, 'Positioning, Offers & the Value Ladder', 2, 'video', '15 min', '[{"title":"HubSpot Academy — free marketing certifications","url":"https://academy.hubspot.com/","type":"course"}]'::jsonb, 'https://www.youtube.com/watch?v=BbJ604IjM5g', '## 🎯 What you will learn
...
- [ ] Value ladder sketched'),
  ('digital-marketing', 'Module 1: Marketing Foundations & Funnels', 0, 'Brand Voice & Messaging Basics', 3, 'video', '13 min', '[{"title":"HubSpot Academy — free marketing certifications","url":"https://academy.hubspot.com/","type":"course"}]'::jsonb, 'https://www.youtube.com/watch?v=BbJ604IjM5g', '## 🎯 What you will learn
...
- [ ] One core message per post'),
  ('digital-marketing', 'Module 2: SEO & Content Marketing', 1, 'How Google Works: Search & Keywords', 0, 'video', '16 min', '[{"title":"Google SEO Starter Guide (official, free PDF-style guide)","url":"https://developers.google.com/search/docs/fundamentals/seo-starter-guide","type":"pdf"}]'::jsonb, 'https://www.youtube.com/watch?v=BbJ604IjM5g', '## 🎯 What you will learn
...
- [ ] Top 2 targets chosen'),
  ('digital-marketing', 'Module 2: SEO & Content Marketing', 1, 'On-Page SEO: Titles, Content & Local Business', 1, 'video', '16 min', '[{"title":"Google SEO Starter Guide (official, free PDF-style guide)","url":"https://developers.google.com/search/docs/fundamentals/seo-starter-guide","type":"pdf"}]'::jsonb, 'https://www.youtube.com/watch?v=G6DmDqYLWL8', '## 🎯 What you will learn
...
- [ ] Local profile checklist ready'),
  ('digital-marketing', 'Module 2: SEO & Content Marketing', 1, 'Content Marketing & Blogging That Attracts', 2, 'video', '15 min', '[{"title":"HubSpot Academy — free marketing certifications","url":"https://academy.hubspot.com/","type":"course"},{"title":"HubSpot blog — content marketing guides","url":"https://blog.hubspot.com/marketing","type":"article"}]'::jsonb, 'https://www.youtube.com/watch?v=BbJ604IjM5g', '## 🎯 What you will learn
...
- [ ] 9 hooks written
- [ ] Week 1 scheduled'),
  ('digital-marketing', 'Module 2: SEO & Content Marketing', 1, 'Repurposing: One Idea, Ten Pieces', 3, 'video', '13 min', '[{"title":"HubSpot Academy — free marketing certifications","url":"https://academy.hubspot.com/","type":"course"}]'::jsonb, 'https://www.youtube.com/watch?v=G6DmDqYLWL8', '## 🎯 What you will learn
...
- [ ] Style stays consistent'),
  ('digital-marketing', 'Module 3: Social Media & Paid Ads', 2, 'Instagram & TikTok Growth Systems', 0, 'video', '16 min', '[{"title":"Meta Blueprint — free Facebook/Instagram ads training","url":"https://www.facebook.com/business/learn","type":"course"}]'::jsonb, 'https://www.youtube.com/watch?v=G6DmDqYLWL8', '## 🎯 What you will learn
...
- [ ] Daily engagement scheduled'),
  ('digital-marketing', 'Module 3: Social Media & Paid Ads', 2, 'WhatsApp Marketing & Community Selling', 1, 'video', '14 min', '[{"title":"WhatsApp Business — official","url":"https://business.whatsapp.com/","type":"tool"}]'::jsonb, 'https://www.youtube.com/watch?v=BbJ604IjM5g', '## 🎯 What you will learn
...
- [ ] Contacts labeled'),
  ('digital-marketing', 'Module 3: Social Media & Paid Ads', 2, 'Meta Ads: Your First Profitable Campaign', 2, 'video', '18 min', '[{"title":"Meta Blueprint — free Facebook/Instagram ads training","url":"https://www.facebook.com/business/learn","type":"course"},{"title":"Google Skillshop — Ads & Analytics certifications","url":"https://skillshop.exceedlms.com/","type":"course"}]'::jsonb, 'https://www.youtube.com/watch?v=G6DmDqYLWL8', '## 🎯 What you will learn
...
- [ ] Cost-per-chat target set'),
  ('digital-marketing', 'Module 3: Social Media & Paid Ads', 2, 'Google Ads Basics & Retargeting', 3, 'video', '16 min', '[{"title":"Google Skillshop — Ads & Analytics certifications","url":"https://skillshop.exceedlms.com/","type":"course"}]'::jsonb, 'https://www.youtube.com/watch?v=BbJ604IjM5g', '## 🎯 What you will learn
...
- [ ] Retargeting message drafted'),
  ('digital-marketing', 'Module 4: Email, Analytics & Freelancing', 3, 'Email Marketing & Automation Basics', 0, 'video', '15 min', '[{"title":"Mailchimp — email marketing starter","url":"https://mailchimp.com/resources/","type":"resource"},{"title":"HubSpot Academy — free marketing certifications","url":"https://academy.hubspot.com/","type":"course"}]'::jsonb, 'https://www.youtube.com/watch?v=BbJ604IjM5g', '## 🎯 What you will learn
...
- [ ] Email tool account ready'),
  ('digital-marketing', 'Module 4: Email, Analytics & Freelancing', 3, 'Analytics: Reading Numbers That Matter', 1, 'video', '16 min', '[{"title":"Google Analytics Academy","url":"https://analytics.google.com/analytics/academy/","type":"course"},{"title":"Google Skillshop — Ads & Analytics certifications","url":"https://skillshop.exceedlms.com/","type":"course"}]'::jsonb, 'https://www.youtube.com/watch?v=G6DmDqYLWL8', '## 🎯 What you will learn
...
- [ ] One data-driven decision made'),
  ('digital-marketing', 'Module 4: Email, Analytics & Freelancing', 3, 'Marketing Freelance: Packages, Clients & Retainers', 2, 'video', '16 min', '[{"title":"HubSpot Academy — free marketing certifications","url":"https://academy.hubspot.com/","type":"course"},{"title":"Upwork — marketing freelance marketplace","url":"https://www.upwork.com/","type":"tool"}]'::jsonb, 'https://www.youtube.com/watch?v=BbJ604IjM5g', '## 🎯 What you will learn
...
- [ ] Case study template ready'),
  ('digital-marketing', 'Module 4: Email, Analytics & Freelancing', 3, 'Capstone: Full Marketing Plan for a Real Business', 3, 'project', '22 min', '[{"title":"HubSpot Academy — free marketing certifications","url":"https://academy.hubspot.com/","type":"course"},{"title":"Google SEO Starter Guide (official, free PDF-style guide)","url":"https://developers.google.com/search/docs/fundamentals/seo-starter-guide","type":"pdf"},{"title":"Meta Blueprint — free Facebook/Instagram ads training","url":"https://www.facebook.com/business/learn","type":"course"}]'::jsonb, 'https://www.youtube.com/watch?v=G6DmDqYLWL8', '## 🎯 What you will learn
...
- [ ] App distributed to real users'),
  ('portfolio-creation', 'Module 1: Portfolio Foundations', 0, 'Your Portfolio Is Your CV: The Mindset Shift', 0, 'video', '13 min', '[{"title":"Behance — free global portfolio platform","url":"https://www.behance.net/","type":"resource"},{"title":"LinkedIn — your professional storefront","url":"https://www.linkedin.com/","type":"resource"}]'::jsonb, 'https://www.youtube.com/watch?v=3KiMwhCuJWs', '## 🎯 What you will learn
...
- [ ] Curation mindset adopted'),
  ('portfolio-creation', 'Module 1: Portfolio Foundations', 0, 'Choosing Your Platform: Where Your Work Lives', 1, 'video', '14 min', '[{"title":"Behance — free global portfolio platform","url":"https://www.behance.net/","type":"resource"},{"title":"GitHub — developer portfolios live here","url":"https://github.com/","type":"resource"},{"title":"Carrd — one-page portfolio sites (free tier)","url":"https://carrd.co/","type":"tool"}]'::jsonb, 'https://www.youtube.com/watch?v=3KiMwhCuJWs', '## 🎯 What you will learn
...
- [ ] WhatsApp reachable from it'),
  ('portfolio-creation', 'Module 1: Portfolio Foundations', 0, 'Anatomy of a Winning Case Study', 2, 'video', '16 min', '[{"title":"Behance — free global portfolio platform","url":"https://www.behance.net/","type":"resource"}]'::jsonb, 'https://www.youtube.com/watch?v=3KiMwhCuJWs', '## 🎯 What you will learn
...
- [ ] Published & shareable'),
  ('portfolio-creation', 'Module 1: Portfolio Foundations', 0, 'Before/After, Mockups & Presentation Magic', 3, 'video', '15 min', '[{"title":"Smartmockups — free device/brand mockups","url":"https://smartmockups.com/","type":"tool"},{"title":"Canva — free design & mockups","url":"https://www.canva.com/","type":"tool"},{"title":"Behance — free global portfolio platform","url":"https://www.behance.net/","type":"resource"}]'::jsonb, 'https://www.youtube.com/watch?v=3KiMwhCuJWs', '## 🎯 What you will learn
...
- [ ] Reel or visual hero ready'),
  ('portfolio-creation', 'Module 2: Personal Brand & Online Presence', 1, 'LinkedIn: Your 24/7 Salesperson', 0, 'video', '15 min', '[{"title":"LinkedIn — your professional storefront","url":"https://www.linkedin.com/","type":"resource"}]'::jsonb, 'https://www.youtube.com/watch?v=UXtcoQAvs4U', '## 🎯 What you will learn
...
- [ ] Content rhythm started'),
  ('portfolio-creation', 'Module 2: Personal Brand & Online Presence', 1, 'Instagram, X & TikTok for Creators', 1, 'video', '14 min', '[{"title":"Dribbble — design showcase","url":"https://dribbble.com/","type":"resource"}]'::jsonb, 'https://www.youtube.com/watch?v=UXtcoQAvs4U', '## 🎯 What you will learn
...
- [ ] 3 posts published
- [ ] CTA in bio working'),
  ('portfolio-creation', 'Module 2: Personal Brand & Online Presence', 1, 'Personal Brand Basics: Name, Story & Consistency', 2, 'video', '13 min', '[{"title":"LinkedIn — your professional storefront","url":"https://www.linkedin.com/","type":"resource"},{"title":"Behance — free global portfolio platform","url":"https://www.behance.net/","type":"resource"}]'::jsonb, 'https://www.youtube.com/watch?v=0CyhIoQlERI', '## 🎯 What you will learn
...
- [ ] Weekly slot protected'),
  ('portfolio-creation', 'Module 2: Personal Brand & Online Presence', 1, 'Networking: The Hidden Job Market', 3, 'video', '14 min', '[{"title":"LinkedIn — your professional storefront","url":"https://www.linkedin.com/","type":"resource"}]'::jsonb, 'https://www.youtube.com/watch?v=0CyhIoQlERI', '## 🎯 What you will learn
...
- [ ] 3 peer referrals built'),
  ('portfolio-creation', 'Module 3: Getting Paid Work', 2, 'Freelance Platforms: Fiverr & Upwork Done Right', 0, 'video', '17 min', '[{"title":"Fiverr — freelance marketplace","url":"https://www.fiverr.com/","type":"resource"},{"title":"Upwork — freelance marketplace","url":"https://www.upwork.com/","type":"resource"}]'::jsonb, 'https://www.youtube.com/watch?v=0CyhIoQlERI', '## 🎯 What you will learn
...
- [ ] 5 applications sent'),
  ('portfolio-creation', 'Module 3: Getting Paid Work', 2, 'Pricing Your Skills in Naira & Dollars', 1, 'video', '15 min', '[{"title":"Fiverr — freelance marketplace","url":"https://www.fiverr.com/","type":"resource"},{"title":"Upwork — freelance marketplace","url":"https://www.upwork.com/","type":"resource"}]'::jsonb, 'https://www.youtube.com/watch?v=0CyhIoQlERI', '## 🎯 What you will learn
...
- [ ] Reframe rehearsed
- [ ] Deposit policy set'),
  ('portfolio-creation', 'Module 3: Getting Paid Work', 2, 'Proposals, Contracts & Professional Delivery', 2, 'video', '16 min', '[{"title":"Fiverr — freelance marketplace","url":"https://www.fiverr.com/","type":"resource"},{"title":"Upwork — freelance marketplace","url":"https://www.upwork.com/","type":"resource"}]'::jsonb, 'https://www.youtube.com/watch?v=UXtcoQAvs4U', '## 🎯 What you will learn
...
- [ ] Presentation habit built'),
  ('portfolio-creation', 'Module 3: Getting Paid Work', 2, 'Getting Your First Client Without Experience', 3, 'video', '15 min', '[{"title":"Fiverr — freelance marketplace","url":"https://www.fiverr.com/","type":"resource"},{"title":"LinkedIn — your professional storefront","url":"https://www.linkedin.com/","type":"resource"}]'::jsonb, 'https://www.youtube.com/watch?v=UXtcoQAvs4U', '## 🎯 What you will learn
...
- [ ] 10 outreach messages sent'),
  ('portfolio-creation', 'Module 4: Growth & Systems', 3, 'Client Management: From First Call to Repeat Business', 0, 'video', '15 min', '[{"title":"LinkedIn — your professional storefront","url":"https://www.linkedin.com/","type":"resource"}]'::jsonb, 'https://www.youtube.com/watch?v=UXtcoQAvs4U', '## 🎯 What you will learn
...
- [ ] Retainer offer defined'),
  ('portfolio-creation', 'Module 4: Growth & Systems', 3, 'Tools & Systems: Running Your Hustle Like a Business', 1, 'video', '14 min', '[{"title":"Carrd — one-page portfolio sites (free tier)","url":"https://carrd.co/","type":"tool"},{"title":"LinkedIn — your professional storefront","url":"https://www.linkedin.com/","type":"resource"}]'::jsonb, 'https://www.youtube.com/watch?v=0CyhIoQlERI', '## 🎯 What you will learn
...
- [ ] Invoice template ready'),
  ('portfolio-creation', 'Module 4: Growth & Systems', 3, 'Building an Income Ladder: One-offs → Products → Agency', 2, 'video', '15 min', '[{"title":"Fiverr — freelance marketplace","url":"https://www.fiverr.com/","type":"resource"},{"title":"Upwork — freelance marketplace","url":"https://www.upwork.com/","type":"resource"}]'::jsonb, 'https://www.youtube.com/watch?v=0CyhIoQlERI', '## 🎯 What you will learn
...
- [ ] Listed for sale'),
  ('portfolio-creation', 'Module 4: Growth & Systems', 3, 'Capstone: Launch Your Portfolio & 30-Day Client Plan', 3, 'project', '20 min', '[{"title":"Behance — free global portfolio platform","url":"https://www.behance.net/","type":"resource"},{"title":"GitHub — developer portfolios live here","url":"https://github.com/","type":"resource"},{"title":"Fiverr — freelance marketplace","url":"https://www.fiverr.com/","type":"resource"},{"title":"Upwork — freelance marketplace","url":"https://www.upwork.com/","type":"resource"},{"title":"LinkedIn — your professional storefront","url":"https://www.linkedin.com/","type":"resource"}]'::jsonb, 'https://www.youtube.com/watch?v=3KiMwhCuJWs', '## 🎯 What you will learn
...
- [ ] Weekly review committed'),
  ('frontend-web-development', 'Module 1: HTML — The Structure of the Web', 0, 'How the Web Works & Your First HTML Page', 0, 'video', '16 min', '[{"title":"MDN Web Docs — Learn web development (global standard)","url":"https://developer.mozilla.org/en-US/docs/Learn","type":"docs"},{"title":"W3Schools HTML reference & exercises","url":"https://www.w3schools.com/html/","type":"docs"},{"title":"HTML5 Notes for Professionals — free PDF","url":"https://goalkicker.com/HTML5Book/","type":"pdf"}]'::jsonb, 'https://www.youtube.com/watch?v=916GWv2Qs08', '## 🎯 What you will learn
...
- [ ] Edit → refresh loop working'),
  ('frontend-web-development', 'Module 1: HTML — The Structure of the Web', 0, 'Text, Links, Images & Lists', 1, 'video', '15 min', '[{"title":"MDN Web Docs — Learn web development (global standard)","url":"https://developer.mozilla.org/en-US/docs/Learn","type":"docs"},{"title":"W3Schools HTML reference & exercises","url":"https://www.w3schools.com/html/","type":"docs"}]'::jsonb, 'https://www.youtube.com/watch?v=916GWv2Qs08', '## 🎯 What you will learn
...
- [ ] Images have alt text'),
  ('frontend-web-development', 'Module 1: HTML — The Structure of the Web', 0, 'Semantic HTML: Professional Page Structure', 2, 'video', '15 min', '[{"title":"MDN Web Docs — Learn web development (global standard)","url":"https://developer.mozilla.org/en-US/docs/Learn","type":"docs"}]'::jsonb, 'https://www.youtube.com/watch?v=916GWv2Qs08', '## 🎯 What you will learn
...
- [ ] Buttons for actions, links for navigation'),
  ('frontend-web-development', 'Module 1: HTML — The Structure of the Web', 0, 'Tables, Forms & HTML Project: Profile Page', 3, 'video', '17 min', '[{"title":"MDN Web Docs — Learn web development (global standard)","url":"https://developer.mozilla.org/en-US/docs/Learn","type":"docs"},{"title":"W3Schools HTML reference & exercises","url":"https://www.w3schools.com/html/","type":"docs"},{"title":"HTML5 Notes for Professionals — free PDF","url":"https://goalkicker.com/HTML5Book/","type":"pdf"}]'::jsonb, 'https://www.youtube.com/watch?v=916GWv2Qs08', '## 🎯 What you will learn
...
- [ ] Form fields all labeled'),
  ('frontend-web-development', 'Module 2: CSS — Styling & Layout', 1, 'CSS Basics: Selectors, Colors & the Cascade', 0, 'video', '16 min', '[{"title":"W3Schools CSS reference & exercises","url":"https://www.w3schools.com/css/","type":"docs"},{"title":"CSS Notes for Professionals — free PDF","url":"https://goalkicker.com/CSSBook/","type":"pdf"},{"title":"MDN Web Docs — Learn web development (global standard)","url":"https://developer.mozilla.org/en-US/docs/Learn","type":"docs"}]'::jsonb, 'https://www.youtube.com/watch?v=1Rs2ND1ryYc', '## 🎯 What you will learn
...
- [ ] I can explain cascade order'),
  ('frontend-web-development', 'Module 2: CSS — Styling & Layout', 1, 'The Box Model: How Every Element Is Sized', 1, 'video', '15 min', '[{"title":"MDN Web Docs — Learn web development (global standard)","url":"https://developer.mozilla.org/en-US/docs/Learn","type":"docs"},{"title":"CSS-Tricks — flexbox, grid & layout guides","url":"https://css-tricks.com/","type":"article"}]'::jsonb, 'https://www.youtube.com/watch?v=1Rs2ND1ryYc', '## 🎯 What you will learn
...
- [ ] DevTools box diagram is familiar'),
  ('frontend-web-development', 'Module 2: CSS — Styling & Layout', 1, 'Flexbox: One-Dimensional Layout Mastery', 2, 'video', '17 min', '[{"title":"CSS-Tricks — flexbox, grid & layout guides","url":"https://css-tricks.com/","type":"article"},{"title":"Flexbox Froggy — learn flexbox by game","url":"https://flexboxfroggy.com/","type":"tool"}]'::jsonb, 'https://www.youtube.com/watch?v=1Rs2ND1ryYc', '## 🎯 What you will learn
...
- [ ] Equal cards with flex:1'),
  ('frontend-web-development', 'Module 2: CSS — Styling & Layout', 1, 'Grid & Responsive Design (Media Queries)', 3, 'video', '18 min', '[{"title":"CSS-Tricks — flexbox, grid & layout guides","url":"https://css-tricks.com/","type":"article"},{"title":"Grid Garden — learn grid by game","url":"https://cssgridgarden.com/","type":"tool"},{"title":"web.dev by Google — modern web courses","url":"https://web.dev/learn","type":"course"}]'::jsonb, 'https://www.youtube.com/watch?v=2rDXik56cxo', '## 🎯 What you will learn
...
- [ ] Page looks right at 3 widths'),
  ('frontend-web-development', 'Module 3: JavaScript — Making Pages Think', 2, 'Variables, Types & Operators', 0, 'video', '16 min', '[{"title":"The Modern JavaScript Tutorial (javascript.info)","url":"https://javascript.info/","type":"docs"},{"title":"JavaScript Notes for Professionals — free 400+ page PDF","url":"https://goalkicker.com/JavaScriptBook/","type":"pdf"},{"title":"freeCodeCamp — free interactive certifications","url":"https://www.freecodecamp.org/learn/","type":"course"}]'::jsonb, 'https://www.youtube.com/watch?v=n8mNX2YqkUs', '## 🎯 What you will learn
...
- [ ] Template literals working'),
  ('frontend-web-development', 'Module 3: JavaScript — Making Pages Think', 2, 'Functions, Conditions & Loops', 1, 'video', '17 min', '[{"title":"The Modern JavaScript Tutorial (javascript.info)","url":"https://javascript.info/","type":"docs"},{"title":"JavaScript Notes for Professionals — free 400+ page PDF","url":"https://goalkicker.com/JavaScriptBook/","type":"pdf"}]'::jsonb, 'https://www.youtube.com/watch?v=n8mNX2YqkUs', '## 🎯 What you will learn
...
- [ ] map + filter + reduce each used'),
  ('frontend-web-development', 'Module 3: JavaScript — Making Pages Think', 2, 'The DOM: Reading & Changing the Page', 2, 'video', '18 min', '[{"title":"The Modern JavaScript Tutorial (javascript.info)","url":"https://javascript.info/","type":"docs"},{"title":"MDN Web Docs — Learn web development (global standard)","url":"https://developer.mozilla.org/en-US/docs/Learn","type":"docs"}]'::jsonb, 'https://www.youtube.com/watch?v=n8mNX2YqkUs', '## 🎯 What you will learn
...
- [ ] Dynamic elements render'),
  ('frontend-web-development', 'Module 3: JavaScript — Making Pages Think', 2, 'Events & Mini Project: Interactive To-Do List', 3, 'video', '19 min', '[{"title":"The Modern JavaScript Tutorial (javascript.info)","url":"https://javascript.info/","type":"docs"},{"title":"freeCodeCamp — free interactive certifications","url":"https://www.freecodecamp.org/learn/","type":"course"}]'::jsonb, 'https://www.youtube.com/watch?v=n8mNX2YqkUs', '## 🎯 What you will learn
...
- [ ] Code understood line by line'),
  ('frontend-web-development', 'Module 4: React & Going Professional', 3, 'Why React & Your First Component', 0, 'video', '16 min', '[{"title":"React Notes for Professionals — free PDF","url":"https://goalkicker.com/ReactBook/","type":"pdf"},{"title":"React official docs (react.dev)","url":"https://react.dev/","type":"docs"}]'::jsonb, 'https://www.youtube.com/watch?v=4UZrsTqkcW4', '## 🎯 What you will learn
...
- [ ] I can say "UI = f(state)"'),
  ('frontend-web-development', 'Module 4: React & Going Professional', 3, 'Props, State & Handling Events in React', 1, 'video', '18 min', '[{"title":"React docs — thinking in React","url":"https://react.dev/learn/thinking-in-react","type":"docs"},{"title":"React Notes for Professionals — free PDF","url":"https://goalkicker.com/ReactBook/","type":"pdf"}]'::jsonb, 'https://www.youtube.com/watch?v=4UZrsTqkcW4', '## 🎯 What you will learn
...
- [ ] Props vs state difference clear'),
  ('frontend-web-development', 'Module 4: React & Going Professional', 3, 'Lists, Fetching Data & Showing Real Content', 2, 'video', '18 min', '[{"title":"React docs — data fetching","url":"https://react.dev/learn","type":"docs"},{"title":"React Notes for Professionals — free PDF","url":"https://goalkicker.com/ReactBook/","type":"pdf"}]'::jsonb, 'https://www.youtube.com/watch?v=CgkZ7MvWUAA', '## 🎯 What you will learn
...
- [ ] Cards display real data'),
  ('frontend-web-development', 'Module 4: React & Going Professional', 3, 'Capstone: Deploy a Portfolio Site & Get Hired', 3, 'project', '22 min', '[{"title":"Netlify — free frontend hosting","url":"https://www.netlify.com/","type":"tool"},{"title":"GitHub — host your code","url":"https://github.com/","type":"tool"},{"title":"freeCodeCamp — free interactive certifications","url":"https://www.freecodecamp.org/learn/","type":"course"}]'::jsonb, 'https://www.youtube.com/watch?v=CgkZ7MvWUAA', '## 🎯 What you will learn
...
- [ ] Portfolio link live
- [ ] 5 applications sent'),
  ('microsoft-excel', 'Module 1: Excel Foundations', 0, 'The Excel Interface: Ribbons, Sheets & Cells', 0, 'video', '14 min', '[{"title":"Microsoft Excel official training","url":"https://support.microsoft.com/en-us/excel","type":"docs"}]'::jsonb, 'https://www.youtube.com/watch?v=Vl0H-qTclOg', '## 🎯 What you will learn
...
- [ ] Sheets renamed & organized'),
  ('microsoft-excel', 'Module 1: Excel Foundations', 0, 'Data Entry, Formatting & Making Data Readable', 1, 'video', '15 min', '[{"title":"Microsoft Excel official training","url":"https://support.microsoft.com/en-us/excel","type":"docs"},{"title":"Free official Excel templates","url":"https://templates.office.com/en-us/templates-for-excel","type":"resource"}]'::jsonb, 'https://www.youtube.com/watch?v=Vl0H-qTclOg', '## 🎯 What you will learn
...
- [ ] Flash Fill tried'),
  ('microsoft-excel', 'Module 1: Excel Foundations', 0, 'Sorting, Filtering & Data Organization', 2, 'video', '15 min', '[{"title":"Microsoft Excel official training","url":"https://support.microsoft.com/en-us/excel","type":"docs"}]'::jsonb, 'https://www.youtube.com/watch?v=qY95fNIBhJE', '## 🎯 What you will learn
...
- [ ] Data passes clean-data rules'),
  ('microsoft-excel', 'Module 1: Excel Foundations', 0, 'Tables: Excel''s Most Underrated Feature', 3, 'video', '13 min', '[{"title":"Microsoft Excel official training","url":"https://support.microsoft.com/en-us/excel","type":"docs"}]'::jsonb, 'https://www.youtube.com/watch?v=Vl0H-qTclOg', '## 🎯 What you will learn
...
- [ ] New rows auto-join
- [ ] Total Row in use'),
  ('microsoft-excel', 'Module 2: Formulas & Functions', 1, 'Formula Basics & the Big 5 Functions', 0, 'video', '17 min', '[{"title":"Microsoft Excel official training","url":"https://support.microsoft.com/en-us/excel","type":"docs"},{"title":"Microsoft Learn — Excel learning paths (free)","url":"https://learn.microsoft.com/en-us/training/browse/?products=excel","type":"course"}]'::jsonb, 'https://www.youtube.com/watch?v=Vl0H-qTclOg', '## 🎯 What you will learn
...
- [ ] Errors read as clues'),
  ('microsoft-excel', 'Module 2: Formulas & Functions', 1, 'IF, COUNTIF & SUMIF: Decisions in Cells', 1, 'video', '17 min', '[{"title":"Microsoft Excel official training","url":"https://support.microsoft.com/en-us/excel","type":"docs"}]'::jsonb, 'https://www.youtube.com/watch?v=Vl0H-qTclOg', '## 🎯 What you will learn
...
- [ ] Nested IF (or IFS) built'),
  ('microsoft-excel', 'Module 2: Formulas & Functions', 1, 'VLOOKUP & XLOOKUP: Joining Data Like a Pro', 2, 'video', '17 min', '[{"title":"Microsoft Excel official training","url":"https://support.microsoft.com/en-us/excel","type":"docs"}]'::jsonb, 'https://www.youtube.com/watch?v=qY95fNIBhJE', '## 🎯 What you will learn
...
- [ ] Clean lookup values (TRIM)'),
  ('microsoft-excel', 'Module 2: Formulas & Functions', 1, 'Text & Date Functions: Cleaning Real-World Data', 3, 'video', '15 min', '[{"title":"Microsoft Excel official training","url":"https://support.microsoft.com/en-us/excel","type":"docs"}]'::jsonb, 'https://www.youtube.com/watch?v=qY95fNIBhJE', '## 🎯 What you will learn
...
- [ ] Dirty data cleaned'),
  ('microsoft-excel', 'Module 3: Analysis & Visualization', 2, 'Charts That Tell the Story', 0, 'video', '16 min', '[{"title":"Microsoft Excel official training","url":"https://support.microsoft.com/en-us/excel","type":"docs"}]'::jsonb, 'https://www.youtube.com/watch?v=Vl0H-qTclOg', '## 🎯 What you will learn
...
- [ ] Clutter removed'),
  ('microsoft-excel', 'Module 3: Analysis & Visualization', 2, 'Conditional Formatting: Data That Highlights Itself', 1, 'video', '14 min', '[{"title":"Microsoft Excel official training","url":"https://support.microsoft.com/en-us/excel","type":"docs"}]'::jsonb, 'https://www.youtube.com/watch?v=qY95fNIBhJE', '## 🎯 What you will learn
...
- [ ] One custom alert rule live'),
  ('microsoft-excel', 'Module 3: Analysis & Visualization', 2, 'Pivot Tables: Summarize 10,000 Rows in 10 Seconds', 2, 'video', '18 min', '[{"title":"Microsoft Excel official training","url":"https://support.microsoft.com/en-us/excel","type":"docs"},{"title":"Microsoft Learn — Excel learning paths (free)","url":"https://learn.microsoft.com/en-us/training/browse/?products=excel","type":"course"}]'::jsonb, 'https://www.youtube.com/watch?v=Vl0H-qTclOg', '## 🎯 What you will learn
...
- [ ] % of total displayed'),
  ('microsoft-excel', 'Module 3: Analysis & Visualization', 2, 'Dashboard Basics: Pivots + Charts + Slicers', 3, 'video', '16 min', '[{"title":"Microsoft Excel official training","url":"https://support.microsoft.com/en-us/excel","type":"docs"},{"title":"Free official Excel templates","url":"https://templates.office.com/en-us/templates-for-excel","type":"resource"}]'::jsonb, 'https://www.youtube.com/watch?v=Vl0H-qTclOg', '## 🎯 What you will learn
...
- [ ] KPIs + charts together'),
  ('microsoft-excel', 'Module 4: Real-World Projects & Automation', 3, 'Project 1: Personal Budget & Expense Tracker', 0, 'video', '18 min', '[{"title":"Free official Excel templates","url":"https://templates.office.com/en-us/templates-for-excel","type":"resource"},{"title":"Microsoft Excel official training","url":"https://support.microsoft.com/en-us/excel","type":"docs"}]'::jsonb, 'https://www.youtube.com/watch?v=qY95fNIBhJE', '## 🎯 What you will learn
...
- [ ] Logging takes <15 seconds'),
  ('microsoft-excel', 'Module 4: Real-World Projects & Automation', 3, 'Project 2: Invoice & Sales System', 1, 'video', '18 min', '[{"title":"Free official Excel templates","url":"https://templates.office.com/en-us/templates-for-excel","type":"resource"},{"title":"Microsoft Excel official training","url":"https://support.microsoft.com/en-us/excel","type":"docs"}]'::jsonb, 'https://www.youtube.com/watch?v=Vl0H-qTclOg', '## 🎯 What you will learn
...
- [ ] One-page PDF export clean'),
  ('microsoft-excel', 'Module 4: Real-World Projects & Automation', 3, 'Project 3: Data Cleaning & Reports Challenge', 2, 'video', '17 min', '[{"title":"Microsoft Excel official training","url":"https://support.microsoft.com/en-us/excel","type":"docs"}]'::jsonb, 'https://www.youtube.com/watch?v=qY95fNIBhJE', '## 🎯 What you will learn
...
- [ ] Clean report exported'),
  ('microsoft-excel', 'Module 4: Real-World Projects & Automation', 3, 'Automation Basics: Macros, Shortcuts & Next Steps', 3, 'project', '16 min', '[{"title":"Microsoft Learn — Excel learning paths (free)","url":"https://learn.microsoft.com/en-us/training/browse/?products=excel","type":"course"},{"title":"Microsoft Excel official training","url":"https://support.microsoft.com/en-us/excel","type":"docs"}]'::jsonb, 'https://www.youtube.com/watch?v=qY95fNIBhJE', '## 🎯 What you will learn
...
- [ ] Power Query explored'),
  ('microsoft-word', 'Module 1: Word Fundamentals', 0, 'Interface, Documents & Typing Like a Pro', 0, 'video', '14 min', '[{"title":"Microsoft Word official training","url":"https://support.microsoft.com/en-us/word","type":"docs"}]'::jsonb, 'https://www.youtube.com/watch?v=C4sYQffoxAU', '## 🎯 What you will learn
...
- [ ] Paste-clean habit formed'),
  ('microsoft-word', 'Module 1: Word Fundamentals', 0, 'Paragraph Formatting & Spacing Done Right', 1, 'video', '15 min', '[{"title":"Microsoft Word official training","url":"https://support.microsoft.com/en-us/word","type":"docs"}]'::jsonb, 'https://www.youtube.com/watch?v=C4sYQffoxAU', '## 🎯 What you will learn
...
- [ ] ¶ diagnostic habit built'),
  ('microsoft-word', 'Module 1: Word Fundamentals', 0, 'Styles: The Single Most Important Word Skill', 2, 'video', '16 min', '[{"title":"Microsoft Word official training","url":"https://support.microsoft.com/en-us/word","type":"docs"},{"title":"Microsoft Learn — Word learning paths (free)","url":"https://learn.microsoft.com/en-us/training/browse/?products=word","type":"course"}]'::jsonb, 'https://www.youtube.com/watch?v=965N2_vtBUc', '## 🎯 What you will learn
...
- [ ] Auto TOC inserted'),
  ('microsoft-word', 'Module 1: Word Fundamentals', 0, 'Tables, Images & Smart Layouts', 3, 'video', '16 min', '[{"title":"Microsoft Word official training","url":"https://support.microsoft.com/en-us/word","type":"docs"}]'::jsonb, 'https://www.youtube.com/watch?v=C4sYQffoxAU', '## 🎯 What you will learn
...
- [ ] Page breaks (not Enters) used'),
  ('microsoft-word', 'Module 2: Professional Documents', 1, 'Letters, Memos & Business Correspondence', 0, 'video', '15 min', '[{"title":"Free official Word templates (CVs, letters, reports)","url":"https://templates.office.com/en-us/templates-for-word","type":"resource"},{"title":"Microsoft Word official training","url":"https://support.microsoft.com/en-us/word","type":"docs"}]'::jsonb, 'https://www.youtube.com/watch?v=C4sYQffoxAU', '## 🎯 What you will learn
...
- [ ] PDF exported'),
  ('microsoft-word', 'Module 2: Professional Documents', 1, 'Reports & Long Documents: TOC, Captions, References', 1, 'video', '17 min', '[{"title":"Microsoft Word official training","url":"https://support.microsoft.com/en-us/word","type":"docs"},{"title":"Microsoft Learn — Word learning paths (free)","url":"https://learn.microsoft.com/en-us/training/browse/?products=word","type":"course"}]'::jsonb, 'https://www.youtube.com/watch?v=965N2_vtBUc', '## 🎯 What you will learn
...
- [ ] Footnote/citation added'),
  ('microsoft-word', 'Module 2: Professional Documents', 1, 'Headers, Footers, Page Numbers & Cover Pages', 2, 'video', '14 min', '[{"title":"Free official Word templates (CVs, letters, reports)","url":"https://templates.office.com/en-us/templates-for-word","type":"resource"}]'::jsonb, 'https://www.youtube.com/watch?v=C4sYQffoxAU', '## 🎯 What you will learn
...
- [ ] TOC uses roman numerals'),
  ('microsoft-word', 'Module 2: Professional Documents', 1, 'Review Tools: Track Changes, Comments & Compare', 3, 'video', '15 min', '[{"title":"Microsoft Word official training","url":"https://support.microsoft.com/en-us/word","type":"docs"}]'::jsonb, 'https://www.youtube.com/watch?v=965N2_vtBUc', '## 🎯 What you will learn
...
- [ ] Inspector run before "final"'),
  ('microsoft-word', 'Module 3: Mail Merge & Productivity', 2, 'Mail Merge: 500 Personalized Letters in 10 Minutes', 0, 'video', '18 min', '[{"title":"Microsoft Word official training","url":"https://support.microsoft.com/en-us/word","type":"docs"},{"title":"Microsoft Learn — Word learning paths (free)","url":"https://learn.microsoft.com/en-us/training/browse/?products=word","type":"course"}]'::jsonb, 'https://www.youtube.com/watch?v=965N2_vtBUc', '## 🎯 What you will learn
...
- [ ] Merge finished cleanly'),
  ('microsoft-word', 'Module 3: Mail Merge & Productivity', 2, 'Templates: Build Once, Reuse Forever', 1, 'video', '14 min', '[{"title":"Free official Word templates (CVs, letters, reports)","url":"https://templates.office.com/en-us/templates-for-word","type":"resource"},{"title":"Microsoft Word official training","url":"https://support.microsoft.com/en-us/word","type":"docs"}]'::jsonb, 'https://www.youtube.com/watch?v=965N2_vtBUc', '## 🎯 What you will learn
...
- [ ] Placeholders clearly marked'),
  ('microsoft-word', 'Module 3: Mail Merge & Productivity', 2, 'Forms & Fillable Documents', 2, 'video', '15 min', '[{"title":"Microsoft Word official training","url":"https://support.microsoft.com/en-us/word","type":"docs"},{"title":"Microsoft Learn — Word learning paths (free)","url":"https://learn.microsoft.com/en-us/training/browse/?products=word","type":"course"}]'::jsonb, 'https://www.youtube.com/watch?v=965N2_vtBUc', '## 🎯 What you will learn
...
- [ ] Filled copy received cleanly'),
  ('microsoft-word', 'Module 3: Mail Merge & Productivity', 2, 'Speed Word: Shortcuts, Find/Replace & Macros', 3, 'video', '14 min', '[{"title":"Microsoft Word official training","url":"https://support.microsoft.com/en-us/word","type":"docs"}]'::jsonb, 'https://www.youtube.com/watch?v=965N2_vtBUc', '## 🎯 What you will learn
...
- [ ] One Quick Part in service'),
  ('microsoft-word', 'Module 4: Real Projects & Getting Paid', 3, 'Project 1: Professional CV & Cover Letter', 0, 'video', '18 min', '[{"title":"Free official Word templates (CVs, letters, reports)","url":"https://templates.office.com/en-us/templates-for-word","type":"resource"},{"title":"Microsoft Word official training","url":"https://support.microsoft.com/en-us/word","type":"docs"}]'::jsonb, 'https://www.youtube.com/watch?v=C4sYQffoxAU', '## 🎯 What you will learn
...
- [ ] PDFs named correctly'),
  ('microsoft-word', 'Module 4: Real Projects & Getting Paid', 3, 'Project 2: Branded Report (Case Study Document)', 1, 'video', '18 min', '[{"title":"Microsoft Word official training","url":"https://support.microsoft.com/en-us/word","type":"docs"},{"title":"Free official Word templates (CVs, letters, reports)","url":"https://templates.office.com/en-us/templates-for-word","type":"resource"}]'::jsonb, 'https://www.youtube.com/watch?v=965N2_vtBUc', '## 🎯 What you will learn
...
- [ ] Zero spelling errors'),
  ('microsoft-word', 'Module 4: Real Projects & Getting Paid', 3, 'Project 3: Mail Merge Campaign (Certificates/Letters)', 2, 'video', '16 min', '[{"title":"Microsoft Word official training","url":"https://support.microsoft.com/en-us/word","type":"docs"},{"title":"Microsoft Learn — Word learning paths (free)","url":"https://learn.microsoft.com/en-us/training/browse/?products=word","type":"course"}]'::jsonb, 'https://www.youtube.com/watch?v=965N2_vtBUc', '## 🎯 What you will learn
...
- [ ] Final batch clean'),
  ('microsoft-word', 'Module 4: Real Projects & Getting Paid', 3, 'Getting Hired: Word Skills That Pay', 3, 'project', '15 min', '[{"title":"Microsoft Learn — Word learning paths (free)","url":"https://learn.microsoft.com/en-us/training/browse/?products=word","type":"course"},{"title":"Free official Word templates (CVs, letters, reports)","url":"https://templates.office.com/en-us/templates-for-word","type":"resource"}]'::jsonb, 'https://www.youtube.com/watch?v=C4sYQffoxAU', '## 🎯 What you will learn
...
- [ ] First offer posted'),
  ('microsoft-powerpoint', 'Module 1: PowerPoint Foundations', 0, 'Interface, Slides & the Golden Rule of Decks', 0, 'video', '14 min', '[{"title":"Microsoft PowerPoint official training","url":"https://support.microsoft.com/en-us/powerpoint","type":"docs"}]'::jsonb, 'https://www.youtube.com/watch?v=0T2lfVwXJLQ', '## 🎯 What you will learn
...
- [ ] Text budget respected'),
  ('microsoft-powerpoint', 'Module 1: PowerPoint Foundations', 0, 'Layouts, Placeholders & Consistent Structure', 1, 'video', '15 min', '[{"title":"Microsoft PowerPoint official training","url":"https://support.microsoft.com/en-us/powerpoint","type":"docs"}]'::jsonb, 'https://www.youtube.com/watch?v=0T2lfVwXJLQ', '## 🎯 What you will learn
...
- [ ] Titles aligned across slides'),
  ('microsoft-powerpoint', 'Module 1: PowerPoint Foundations', 0, 'Slide Master: Style Once, Apply Everywhere', 2, 'video', '16 min', '[{"title":"Microsoft PowerPoint official training","url":"https://support.microsoft.com/en-us/powerpoint","type":"docs"},{"title":"Microsoft Learn — PowerPoint paths (free)","url":"https://learn.microsoft.com/en-us/training/browse/?products=powerpoint","type":"course"}]'::jsonb, 'https://www.youtube.com/watch?v=QxkXikn-cr0', '## 🎯 What you will learn
...
- [ ] .potx template saved'),
  ('microsoft-powerpoint', 'Module 1: PowerPoint Foundations', 0, 'Working with Text: Hierarchy & Readability', 3, 'video', '14 min', '[{"title":"Microsoft PowerPoint official training","url":"https://support.microsoft.com/en-us/powerpoint","type":"docs"}]'::jsonb, 'https://www.youtube.com/watch?v=0T2lfVwXJLQ', '## 🎯 What you will learn
...
- [ ] Accent color used sparingly'),
  ('microsoft-powerpoint', 'Module 2: Visual Design', 1, 'Images, Icons & Removing Backgrounds', 0, 'video', '16 min', '[{"title":"Unsplash — free high-quality photos","url":"https://unsplash.com/","type":"resource"},{"title":"Flaticon — free icons","url":"https://www.flaticon.com/","type":"resource"}]'::jsonb, 'https://www.youtube.com/watch?v=QxkXikn-cr0', '## 🎯 What you will learn
...
- [ ] Icons in one style'),
  ('microsoft-powerpoint', 'Module 2: Visual Design', 1, 'Shapes, SmartArt & Data Slides', 1, 'video', '16 min', '[{"title":"Microsoft PowerPoint official training","url":"https://support.microsoft.com/en-us/powerpoint","type":"docs"}]'::jsonb, 'https://www.youtube.com/watch?v=0T2lfVwXJLQ', '## 🎯 What you will learn
...
- [ ] One insight highlighted per chart'),
  ('microsoft-powerpoint', 'Module 2: Visual Design', 1, 'Alignment, Whitespace & the Design Eye', 2, 'video', '15 min', '[{"title":"Microsoft PowerPoint official training","url":"https://support.microsoft.com/en-us/powerpoint","type":"docs"}]'::jsonb, 'https://www.youtube.com/watch?v=QxkXikn-cr0', '## 🎯 What you will learn
...
- [ ] Audit run on all slides'),
  ('microsoft-powerpoint', 'Module 2: Visual Design', 1, 'Transitions & Animations: Motion With Purpose', 3, 'video', '15 min', '[{"title":"Microsoft PowerPoint official training","url":"https://support.microsoft.com/en-us/powerpoint","type":"docs"}]'::jsonb, 'https://www.youtube.com/watch?v=QxkXikn-cr0', '## 🎯 What you will learn
...
- [ ] Animation Pane order checked'),
  ('microsoft-powerpoint', 'Module 3: Presenting & Delivering', 2, 'Presenter View, Notes & Rehearsal', 0, 'video', '14 min', '[{"title":"Microsoft PowerPoint official training","url":"https://support.microsoft.com/en-us/powerpoint","type":"docs"},{"title":"Microsoft Learn — PowerPoint paths (free)","url":"https://learn.microsoft.com/en-us/training/browse/?products=powerpoint","type":"course"}]'::jsonb, 'https://www.youtube.com/watch?v=0T2lfVwXJLQ', '## 🎯 What you will learn
...
- [ ] Live tools practiced'),
  ('microsoft-powerpoint', 'Module 3: Presenting & Delivering', 2, 'Storytelling: Structure That Persuades', 1, 'video', '15 min', '[{"title":"Microsoft PowerPoint official training","url":"https://support.microsoft.com/en-us/powerpoint","type":"docs"}]'::jsonb, 'https://www.youtube.com/watch?v=QxkXikn-cr0', '## 🎯 What you will learn
...
- [ ] Ruthless cuts made'),
  ('microsoft-powerpoint', 'Module 3: Presenting & Delivering', 2, 'Exporting, Sharing & File Hygiene', 2, 'video', '13 min', '[{"title":"Microsoft PowerPoint official training","url":"https://support.microsoft.com/en-us/powerpoint","type":"docs"}]'::jsonb, 'https://www.youtube.com/watch?v=0T2lfVwXJLQ', '## 🎯 What you will learn
...
- [ ] Clean naming convention'),
  ('microsoft-powerpoint', 'Module 3: Presenting & Delivering', 2, 'Slide Makeover: From Wall of Text to Wow', 3, 'video', '16 min', '[{"title":"Free official PowerPoint templates","url":"https://templates.office.com/en-us/templates-for-powerpoint","type":"resource"},{"title":"Unsplash — free high-quality photos","url":"https://unsplash.com/","type":"resource"}]'::jsonb, 'https://www.youtube.com/watch?v=QxkXikn-cr0', '## 🎯 What you will learn
...
- [ ] Polished & aligned'),
  ('microsoft-powerpoint', 'Module 4: Capstone & Freelance', 3, 'Capstone: Build a Complete Pitch Deck', 0, 'video', '20 min', '[{"title":"Microsoft PowerPoint official training","url":"https://support.microsoft.com/en-us/powerpoint","type":"docs"},{"title":"Free official PowerPoint templates","url":"https://templates.office.com/en-us/templates-for-powerpoint","type":"resource"}]'::jsonb, 'https://www.youtube.com/watch?v=QxkXikn-cr0', '## 🎯 What you will learn
...
- [ ] Rehearsed once, PDF exported'),
  ('microsoft-powerpoint', 'Module 4: Capstone & Freelance', 3, 'Teaching Decks & Training Materials', 1, 'video', '15 min', '[{"title":"Microsoft Learn — PowerPoint paths (free)","url":"https://learn.microsoft.com/en-us/training/browse/?products=powerpoint","type":"course"},{"title":"Microsoft PowerPoint official training","url":"https://support.microsoft.com/en-us/powerpoint","type":"docs"}]'::jsonb, 'https://www.youtube.com/watch?v=0T2lfVwXJLQ', '## 🎯 What you will learn
...
- [ ] Handout + worksheet packaged'),
  ('microsoft-powerpoint', 'Module 4: Capstone & Freelance', 3, 'Selling Presentation Services', 2, 'video', '15 min', '[{"title":"Fiverr — presentation design marketplace","url":"https://www.fiverr.com/","type":"resource"},{"title":"Upwork","url":"https://www.upwork.com/","type":"resource"}]'::jsonb, 'https://www.youtube.com/watch?v=0T2lfVwXJLQ', '## 🎯 What you will learn
...
- [ ] 5 pitches sent'),
  ('microsoft-powerpoint', 'Module 4: Capstone & Freelance', 3, 'The Full Office Pro: Word + Excel + PowerPoint Careers', 3, 'project', '15 min', '[{"title":"Microsoft Learn — PowerPoint paths (free)","url":"https://learn.microsoft.com/en-us/training/browse/?products=powerpoint","type":"course"},{"title":"Microsoft Office Specialist certification info","url":"https://learn.microsoft.com/en-us/credentials/certifications/office-specialist/","type":"course"}]'::jsonb, 'https://www.youtube.com/watch?v=QxkXikn-cr0', '## 🎯 What you will learn
...
insert into _seed_project (course_slug, title, description, instructions, required_output, lesson_title) values
  ('ai-video-content-creation', 'Final Project: AI Video Campaign for a Real Brand', 'Produce a complete short AI-video campaign for a real business or brand (yours or a volunteer client’s).', '1) Write a 30–60 second script using the hook → value → CTA structure.
...
5) Apply hierarchy, alignment and white-space rules throughout.', 'A presentation (PDF) showing all pieces with your design rationale, plus the flyer exported as print-ready PDF.', 'Capstone: Complete Brand Package for a Real Business'),
  ('digital-marketing', 'Final Project: Growth Plan for a Nigerian Business', 'Build a complete 30-day digital marketing plan for a real local business (yours, a friend’s, or a volunteer client).', '1) Audit their current online presence (profile, posts, reviews).
...
5) Distribute to at least 10 real users (Play Store, APK share, or TestFlight) and collect their feedback.', 'Repository link + release APK/AAB (or store listing) + a short report: features, architecture, user feedback, next improvements.', 'Capstone: Build & Publish Your App'),
  ('portfolio-creation', 'Final Project: Your Live Portfolio + First Outreach Sprint', 'Launch your complete professional presence and run your first client outreach.', '1) Publish 3 case studies on your showcase platform (Behance/GitHub/YouTube/Drive as fits your skill).
...
5) Run the outreach sprint: 10 personalized messages to potential clients/employers, logging every response.', 'Links to your published portfolio + home base + the outreach log (who, what you sent, replies) + a 1-page reflection on what you’ll improve next month.', 'Capstone: Launch Your Portfolio & 30-Day Client Plan'),
  ('frontend-web-development', 'Final Project: Responsive Business Website', 'Build and deploy a responsive multi-section website for a business using HTML, CSS and JavaScript.', '1) Requirements: semantic HTML, responsive layout (mobile-first), at least one interactive feature built with JavaScript (menu toggle, form validation, gallery, or dark-mode switch).
...
6) Publish the case study (problem → research → design → validation) on Behance.', 'Behance case study link + clickable Figma prototype link + summary of test findings and fixes.', 'Capstone: Case Study Portfolio & First Design Job'),
  ('microsoft-excel', 'Final Project: Business Dashboard Workbook', 'Build an Excel workbook that manages and reports on a realistic business dataset (sales, inventory or expenses).', '1) Create a clean data table (50+ rows) with proper headers, no merged cells — convert it to a Table (Ctrl+T).
...
5) Assemble a one-screen dashboard: KPIs, 2 charts from the pivot, a slicer, and a clear title.', 'Submit the .xlsx workbook plus a one-page PDF explaining what each sheet does and the 3 questions your dashboard answers.', 'Automation Basics: Macros, Shortcuts & Next Steps'),
  ('microsoft-word', 'Final Project: Professional Document Portfolio', 'Produce three polished professional documents demonstrating full Word mastery.', '1) A one-page CV with a matching cover letter (consistent style, quantified bullets).
...
Run spell check and Document Inspector on everything.', 'Three final PDFs + the .dotx template + a short note describing the techniques used in each.', 'Getting Hired: Word Skills That Pay'),
  ('microsoft-powerpoint', 'Final Project: A Presentation That Wins the Room', 'Create a 10–12 slide pitch or training deck and deliver it like a professional.', '1) Choose a real topic: a business pitch, a training lesson, or a project proposal.
...
5) Add speaker notes to every slide, rehearse once with the timer, and export both PPTX and PDF.', 'The PPTX + PDF + a 60–90 second video (or audio) of you presenting 2–3 key slides.', 'The Full Office Pro: Word + Excel + PowerPoint Careers')
;
