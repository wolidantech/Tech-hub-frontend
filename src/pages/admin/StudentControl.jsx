    ...
    <div className="space-y-6">
      <div className="flex flex-wrap gap-4 items-center justify-between">
        ...
        <div className="relative w-full sm:w-auto">
          ...
          <input value={search} onChange={(e) => setSearch(e.target.value)} placeholder="Search students..." type="search" autoComplete="off" enterKeyHint="search" className="h-11 w-full sm:w-[280px] rounded-full glass pl-10 pr-4 text-sm" />
        </div>
      </div>
